...
export default function CardDetails() {
  return (
    <div>
      <div className="w-[100%] 2xl:w-[84%] rounded-[10px] mb-[15px] mt-[15px] bg-white">
        <div className="flex items-center justify-center mt-[15px]">
          <div className="w-[80%] lg:w-[65%]  rounded-[15px] flex flex-col gap-10 sm:flex-row-reverse items-center text-left  bg-[#FAFAFA]">
            <div>
              <Image
                src="/img/imageLoginPage/prod26.png.png"
                width={900}
                height={600}
        ...
        <div className="w-[70%] lg:w-[40%] mx-auto h-[200px] mt-[15px] mb-[15px] rounded-[15px] bg-white border-green-400 border flex justify-center items-center">
