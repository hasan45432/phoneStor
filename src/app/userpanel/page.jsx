  ...
  return (
    <>
      <div className="w-[100%] 2xl:w-[84%] bg-white rounded-[10px] mb-[15px] mt-[15px]">
        <div className="flex flex-row-reverse p-[30px] ">
          <div className="bg-[#FAFAFA] w-[30%] text-left rounded-[10px] flex  items-end flex-col">
            <div>
              <Image
          ...
          <div className="w-[100%]">
            <div className="flex flex-col gap-10  items-center text-left">
              <p className="text-[18px] font-bold border w-[50%] h-[45px] rounded-[10px] p-2">
                First Name * :{" "}
